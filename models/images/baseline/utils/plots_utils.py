...
# ░░░░░░░░░░░░░░ 📈 Plots : Baseline ░░░░░░░░░░░░░░
def plot_baseline(history, timestamp: str):
    """
    Plot training metrics (Loss, Accuracy, Precision, Recall, AUC)
    for the baseline model.
    """

    _fig, ax = plt.subplots(1, 5, figsize=(20, 5))
    ...
    ax[2].plot(history.epoch, history.history["precision"],
               label="Train precision")
    ax[2].plot(history.epoch, history.history["val_precision"],
               label="Val precision")

    # ░░ Row 1 : Train & Val Recall ░░
    ax[3].set_title('Recall')
    ax[3].plot(history.epoch, history.history["recall"], label="Train recall")
    ax[3].plot(history.epoch, history.history["val_recall"],
               label="Val recall")
